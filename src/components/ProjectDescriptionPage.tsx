  ...
  return (
    <div className="flex flex-col items-center justify-center w-full overflow-y-auto">
      ...
      <div className="p-10 flex flex-col items-center justify-center w-fit">
        ...
        <p className="max-w-prose text-lg pb-8">
          I used the Alpha Vantage API to gather stock price data. The API call
          I used returned <code>time_stamp</code>, <code>open</code>,{" "}
          <code>close</code>, and <code>volume</code> datapoints for as long as
          the company has been publicly traded. With this data, I was able to
          engineer many other features that would aid in model training.
        </p>
        <Collapsible className="flex flex-col items-start justify-start text-left w-full">
          <CollapsibleTrigger className="w-full flex flex-row justify-start pb-2">
            <h3 className="text-xl text-left text-muted-foreground font-bold">
              Feature Engineering
            </h3>
          </CollapsibleTrigger>
          <CollapsibleContent>
